...
\textbf{Outils d'IA} : assistance algorithmique pour la réimplémentation
FairGNN-GRL, la migration pandas $\to$ polars, l'intégration TabICL,
l'ajout des modules INLP / calibration / reweighting, et la rédaction.
Code revu, testé, exécuté par les auteurs.
...
\textbf{TabICL+ULTIMATE-LATENT}\textsuperscript{$\dagger$} & gender & 0.8898 & 0.8888 & 0.0057 & 0.0094 & 0.5545 \\
\bottomrule
\end{tabular}
\end{center}
...
\subsection*{A.2 ULTIMATE composite — un seul fit règle TOUT (Pokec-z, seed=42)}
